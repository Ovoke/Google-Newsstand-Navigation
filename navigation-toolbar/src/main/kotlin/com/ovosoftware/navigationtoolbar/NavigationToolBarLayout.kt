...
class NavigationToolBarLayout : CoordinatorLayout {
    ...
    constructor(context: Context, attrs: AttributeSet?, @AttrRes defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        toolBar = findViewById(R.id.com_ovosoftware_toolbar)
        headerLayout = findViewById(R.id.com_ovosoftware_header_layout)
        ...
        appBarLayout = findViewById(R.id.com_ovosoftware_app_bar)
    ...
    private fun initBackgroundLayout(context: Context, layoutId: Int) {
        val ctl = findViewById<CollapsingToolbarLayout>(R.id.com_ovosoftware_toolbar_layout)
